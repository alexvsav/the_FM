  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: phColors.bg, fontFamily: 'Montserrat, sans-serif'}}>
      ...
      <div className="border-b sticky top-0 z-10" style={{backgroundColor: phColors.bgCard, borderColor: phColors.border}}>
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-6">
            <div>
              <div className="text-2xl font-bold" style={{color: phColors.accent}}>The F*** Map</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {/* SEO Content Section - Hidden on Mobile, Visible to Google */}
        <div className="mb-6 rounded-3xl shadow-xl p-8" style={{backgroundColor: phColors.bgCard, border: `1px solid ${phColors.border}`}}>
          <h1 className="text-4xl font-bold mb-4" style={{color: phColors.accent}}>
            The F*** Map: Track Your International Sexual Geography
          </h1>
          
          <div className="space-y-4" style={{color: phColors.textGray, lineHeight: '1.8'}}>
            <p>
              The F*** Map is an adult-oriented platform where users track sexual encounters 
              by the citizenship of their partners. Select countries to mark your conquests 
              and compete on global leaderboards. Calculate your score across 196 countries 
              based on population rarity.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div>
                <h2 className="text-xl font-bold mb-3" style={{color: phColors.text}}>Features</h2>
                <ul className="space-y-2" style={{listStyleType: 'disc', paddingLeft: '1.5rem'}}>
                  <li>Track sexual encounters by citizenship</li>
                  <li>Global and country-specific leaderboards</li>
                  <li>Population-based scoring (rare countries = more points)</li>
                  <li>196 UN member states</li>
              ...
              <div>
                <h2 className="text-xl font-bold mb-3" style={{color: phColors.text}}>How It Works</h2>
                <ol className="space-y-2" style={{listStyleType: 'decimal', paddingLeft: '1.5rem'}}>
                  <li>Create your username and select citizenship</li>
                  <li>Mark countries you've "collected"</li>
                  <li>Earn points based on population rarity</li>
            ...
            <div className="mt-6 p-4 rounded-xl" style={{backgroundColor: phColors.bgLight}}>
              <p className="text-sm">
                <strong style={{color: phColors.accent}}>Scoring System:</strong> Countries are worth 
                different points based on population. Vatican City (825 people) = 50 points. 
                China (1.4 billion) = 1 point. Smaller populations are rarer encounters, 
                thus worth more points. Track your international dating geography and 
                compete with thousands of users worldwide.
              </p>
            </div>
          </div>
        </div>
